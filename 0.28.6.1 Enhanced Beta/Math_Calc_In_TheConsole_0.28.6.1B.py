...
try:
    ...
    versionOfApp = "0.28.6.1 Enhanced Beta"
    ...
    def QuickOperations():
        ...
        while True:
            ...
            if actInput == "ForceAction.Exit":
                ...
                squareSqrtConfirmation = input("Would you like to get its square root? Type Y or Yes to get the square root. Otherwise, type N or No. This is NOT case-sensitive. ")
                while True:
                    if squareSqrtConfirmation == "Y":
                        ...
                        AppHome()
                        QuickOperations()
                    elif squareSqrtConfirmation == "N":
                        print("The SQRT operation in Squaring has been cancelled.")
                        sleep(15)
                        AppHome()
                        QuickOperations()
                    elif squareSqrtConfirmation == "n":
                        ...
                        AppHome()
                        QuickOperations()
                    elif squareSqrtConfirmation == "No":
                        print("The SQRT operation in Squaring has been cancelled.")
                        sleep(15)
                        AppHome()
                        QuickOperations()
